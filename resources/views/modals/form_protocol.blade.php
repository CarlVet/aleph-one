<div>
    <div class="mt-2 md:col-span-2 md:mt-0">
        ...
        <x-forms.form method="POST" action="/protocols" enctype="multipart/form-data">
            @csrf
            <div class="shadow-xl sm:overflow-hidden sm:rounded-xl bg-gradient-to-br from-white to-gray-50">
                <div class="space-y-6 bg-white px-8 py-6 rounded-xl">
                    <div class="text-center mb-6">
                        <h2 class="text-2xl font-bold text-gray-800">Protocol Registration Form</h2>
                        <p class="mt-2 text-sm text-gray-600">Fill in the details below to register a new protocol</p>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <x-forms.field label="Enter protocol name in full (e.g. ITS cPCR or IS711 real-time PCR):"
                                name="protocol_name">
                                ...
                                <div id="protocol_name_status" class="mt-1 text-sm hidden"></div>
                            </x-forms.field>
                            ...
                            <!-- Input for pathogen -->
                            <x-forms.field label="Pathogens targeted:" name="pathogens_protocol[]">
                                <x-forms.select-input id="pathogens_protocol" name="pathogens_protocol[]" multiple
                                    required class="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm transition-all duration-200">
                            ...
                            <button id="pathogen_btn" type="button"
                            ...
                            <x-forms.field label="Select or enter reference key:" name="ref_new[]">
                                <x-forms.select-input id="ref_new" name="ref_new[]" multiple required
                                    class="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm transition-all duration-200">
                            ...
                            <button id="study_btn" type="button"
                                class="group relative inline-flex items-center justify-center px-4 py-2 text-sm font-medium transition-all duration-300 ease-in-out transform hover:scale-105 bg-gradient-to-r from-amber-400 to-amber-500 text-white rounded-lg shadow-md hover:shadow-lg border border-amber-500">
                                <i class="fas fa-plus-circle mr-2 text-lg group-hover:rotate-90 transition-transform duration-300"></i>
                                Create New Study
                            </button>
                        ...
                        <div class="space-y-6 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <x-forms.field label="Upload protocol document (optional):" name="protocol_pdf" class="mt-4">
                                <div class="text-xs text-gray-500 mb-2">Max file size: 50MB • Formats: PDF, DOC, DOCX</div>
        ...
        <!-- Study Form Modal -->
        <x-table-modal id="study_modal" title="Study Registration Form" closeButtonId="study_close_btn">
            @include('modals.form_study_on_exp')
        </x-table-modal>

        <!-- Pathogen Form Modal -->
        <x-table-modal id="pathogen_modal" title="Pathogen Registration Form" closeButtonId="pathogen_close_btn">
