<div>
    ...
    <div class="mt-8 border border-gray-200 rounded-xl shadow-xl bg-white">
        <div class="flex flex-col items-center w-full p-4">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mb-4">{{ $isEditing ? 'Edit Parasite Box Positions' : 'List of Parasite Box Positions' }}</h2>
        ...
        <table id="box_positions_parasite_table" class="index-data-table min-w-full divide-y divide-gray-200 {{ ($showBulkActions ?? false) ? 'has-bulk-select' : '' }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if ($isEditing)
                                <x-forms.select-input id="content_type" name="content_type"
                                    ...
                                    <option value="Parasite samples" {{ 'Parasite samples' === $box_position->boxes->content_type ? 'selected' : '' }}>Parasite samples</option>
                                    <option value="Parasite nucleic acids" {{ 'Parasite nucleic acids' === $box_position->boxes->content_type ? 'selected' : '' }}>Parasite nucleic acids</option>
                                </x-forms.select-input>
                            @else
                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-gradient-to-r from-purple-100 to-purple-200 text-purple-800 shadow-sm">
