        ...
        <div class="flex items-start justify-between gap-6">
            <div>
                <h3 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                    ...
                    Bulk import environment samples (CSV)
                </h3>
        ...
        <div x-show="templateOpen" x-cloak
            ...
            <div class="flex h-[95vh] w-full max-w-[98vw] flex-col overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/10">
                <div class="flex items-start justify-between gap-6 border-b border-gray-200 bg-gray-50 px-6 py-4">
                    <div>
                        <h4 class="text-lg font-semibold text-gray-900">Environment samples import template (CSV)</h4>
                        <p class="mt-1 text-sm text-gray-600">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-3 text-sm text-gray-900">
                                        <div class="inline-flex items-center gap-1">
                                            @if (empty($row['environment_sample_type']))
                                                <i class="fa-solid fa-circle-xmark text-red-700"></i>
                                            @elseif (!empty($row['field_warnings']['environment_sample_type']))
                                            ...
                                            @endif
                                            <span>{{ $row['environment_sample_type'] ?: '-' }}</span>
                                        </div>
                                        @if (empty($row['sample_type_exists']))
                                            <div class="mt-1 inline-flex w-full items-center gap-2">
                                                @if (empty($row['environment_sample_type_category']))
                                                    <i class="fa-solid fa-circle-xmark text-red-700"></i>
                                                @else
                                                    <i class="fa-solid fa-plus text-green-700"></i>
                                                @endif
                                                <input type="text"
                                                    wire:model.live="rowOverrides.{{ (int) ($row['row_number'] ?? 0) }}.environment_sample_type_category"
                                                    placeholder="Category for new sample type"
