<div>
    ...
    <div class="mt-8 border border-gray-200 rounded-xl shadow-xl bg-white">
        <div class="flex flex-col items-center w-full p-4">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mb-4">{{ $isEditing ? 'Edit Human Box Positions' : 'List of Human Box Positions' }}</h2>
        ...
        <table id="box_positions_human_table" class="index-data-table min-w-full divide-y divide-gray-200 {{ ($showBulkActions ?? false) ? 'has-bulk-select' : '' }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if ($isEditing)
                                <x-forms.select-input id="content_type" name="content_type"
                                    ...
                                    <option value="Human samples" {{ 'Human samples' === $box_position->boxes->content_type ? 'selected' : '' }}>Human samples</option>
                                    <option value="Human nucleic acids" {{ 'Human nucleic acids' === $box_position->boxes->content_type ? 'selected' : '' }}>Human nucleic acids</option>
