    ...
    <div class="text-center mt-2">
        ...
        <div class="mt-8 border border-gray-200 rounded-xl shadow-xl bg-white">
            <div class="flex flex-col items-center w-full p-4">
                ...
                <h3 class="text-lg text-gray-600 mb-4">from human samples</h3>
                ...
                @if ($showBulkActions)
                    <div class="mt-3 flex items-center gap-3">
                        ...
                        <span class="text-sm text-gray-600">
                            {{ count(array_filter($selectedMetaHumans ?? [])) }} selected
                        </span>
                    </div>
                @endif
            </div>

            @include('livewire.partials.index-per-page-toolbar', ['paginator' => $meta_humans])


            <div class="index-table-container overflow-x-auto">
            <table id="meta_humans_table" class="index-data-table min-w-full divide-y divide-gray-200 {{ ($showBulkActions ?? false) ? 'has-bulk-select' : '' }}">
                <thead>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr wire:key="{{ $meta->id }}"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap min-w-[18rem]">
                                @if ($isEditing && ! $isGuestMode && $canEdit)
                                    <select
                                        class="w-full min-w-[18rem] rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-800 shadow-sm focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap min-w-[18rem]">
                                @if ($isEditing && ! $isGuestMode && $canEdit)
                                    <input type="text"
                                        ...
                                        "
                                        class="w-full min-w-[18rem] px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent shadow-sm transition-all duration-200"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if ($isEditing && ! $isGuestMode && $canEdit)
                                    ...
                                    <input type="date"
                                        ...
                                        "
                                        class="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent shadow-sm transition-all duration-200">
                                @else
                            ...
                            <td class="px-6 py-4 whitespace-nowrap min-w-[10rem]">
                                @if ($isEditing && ! $isGuestMode && $canEdit)
                                    <input type="number" min="0"
                                        ...
                                        "
                                        class="w-full min-w-[10rem] px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent shadow-sm transition-all duration-200"
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ ($isGuestMode ? 16 : 15) + ($showBulkActions ? 1 : 0) }}"
            ...
            @include('livewire.partials.index-pagination-bar', ['paginator' => $meta_humans])
        </div>
    </div>
</div>
