...
class PoolsCreateSelectionsController extends Controller
{
    ...
    public function humanTubes(Request $request): View
    {
        ...
        $paginationPath = route('pools.create.tubes.human');
    ...
    public function animalTubes(Request $request): View
    {
        ...
        $paginationPath = route('pools.create.tubes.animal');
    ...
    public function environmentTubes(Request $request): View
    {
        ...
        $paginationPath = route('pools.create.tubes.environment');
    ...
    public function parasiteTubes(Request $request): View
    {
        ...
        $paginationPath = route('pools.create.tubes.parasite');
    ...
    public function nucleicTubes(Request $request): View
    {
        ...
        $paginationPath = route('pools.create.tubes.nucleic');
    ...
    public function cultureTubes(Request $request): View
    {
        ...
        $paginationPath = route('pools.create.tubes.culture');
    ...
    private function applyNucleicTubeFilters(Builder $query, array $filters): void
    {
        ...
        if (! empty($filters[3])) {
            $query->where('preservant', 'like', '%'.trim((string) $filters[3]).'%');
        }
    ...
    private function applyCultureTubeFilters(Builder $query, array $filters): void
    {
        ...
        if (! empty($filters[2])) {
            $query->where('preservant', 'like', '%'.trim((string) $filters[2]).'%');
        }
