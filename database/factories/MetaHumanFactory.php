...
/**
 * @extends Factory<MetaHuman>
 */
class MetaHumanFactory extends Factory
{
    public function configure(): static
    {
        return $this->afterCreating(function (MetaHuman $metaHuman): void {
            ...
            $metaHuman->risk_factors()->sync($riskFactorIds->all());
            ...
            $metaHuman->clinical_signs()->sync($clinicalSignIds->all());
            ...
            $metaHuman->lesions()->sync($lesionIds->all());
        });
    }
    ...
    public function definition(): array
    {
        return [
            ...
            'age_group' => $this->faker->optional(0.7)->randomElement(['Child', 'Adolescent', 'Young Adult', 'Adult', 'Elderly', 'Unknown']),
            'job' => $this->faker->optional(0.6)->randomElement(['Farmer', 'Veterinarian', 'Student', 'Healthcare Worker', 'Laboratory Technician', 'Researcher', 'Other']),
