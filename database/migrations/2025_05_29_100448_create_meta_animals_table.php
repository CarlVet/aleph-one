...
return new class extends Migration
{
    ...
    {
        Schema::create('meta_animals', function (Blueprint $table) {
            $table->id();
            $table->foreignId('studies_id')->constrained('studies')->onDelete('cascade');
            $table->foreignId('animal_species_id')->constrained('animal_species')->onDelete('cascade');
            ...
            $table->foreignId('sample_types_id')->constrained('sample_types')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('meta_animals');
    }
};
