...
return new class extends Migration
{
    ...
    {
        Schema::create('human_health', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(ClinicalSigns::class)->constrained()->cascadeOnDelete();
            $table->foreignIdFor(Lesions::class)->constrained()->cascadeOnDelete();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('human_health');
    }
};
