$(document).ready(function () {
  ...
  const $nameInput = $('#site_name');
  const $status = $('#site_name_status');
  const $submitBtn = $('#sampling_site_submit_btn');
...
$(document).ready(function () {
  const successMessageElement = document.getElementById('samplingSiteSuccessMessage');
  const errorMessageElement = document.getElementById('samplingSiteErrorMessage');
