$(document).ready(function () {
  ...
  $('#location_type').selectize({
    placeholder: "Search or enter new location type",
    create: true,
  ...
  $('#site_organization_form_btn').on('click', function () {
    $('#site_organization_form_modal').removeClass('hidden');
  });

  $('#site_organization_form_close_btn').on('click', function () {
    $('#site_organization_form_modal').addClass('hidden');
  });

  $('#location_lab_form_btn').on('click', function () {
    $('#location_lab_form_modal').removeClass('hidden');
  });

  $('#location_lab_form_close_btn').on('click', function () {
    $('#location_lab_form_modal').addClass('hidden');
  });
  ...
  const $status = $('#location_name_status');
  const $submitBtn = $('#location_submit_btn');
